...
<div class="register-box">
  <div class="register-logo">
    <a href="{{ asset('theme_assests/index2.html') }}"><b>Admin</b>Registration</a>
  </div>
     ...
     @endif
      <form action="{{ url('/admin/registration') }}" method="post">
        ...
        <div class="input-group mb-3">
          <input type="text" class="form-control" placeholder="Full name" name="name" pattern="[a-z A-Z]*" title="Please Enter Valid Username Name" required >
      ...
      @endif
        ...
        @endif
        <div class="input-group mb-3">
          <input type="password" class="form-control" placeholder="Password" name="password" minlength="8" maxlength="50" required>
          <div class="input-group-append">
            <div class="input-group-text">
