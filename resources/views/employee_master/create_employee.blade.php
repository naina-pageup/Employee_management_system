              ...
              <i class="fa fa-refresh fa-spin"></i>
                ...
                <form id="add-designation-form" action="{{ url('admin/employee/store') }}" method="POST">
                    ...
                    <div class="row">
                      ...
                      <label>Name</label>
                        <input type="text" class="form-control" placeholder="Name" name="name" autocomplete="off" pattern="[a-z A-Z]*" title="Please Enter Valid Username Name"  required>
                      </div>
                      ...
                      <div class="col-6 form-group">
                      <label>Mobile</label>
                        <input type="number" class="form-control" placeholder="Mobile" name="mobile"  minlength="10" maxlength="10" autocomplete="off" required>
                      </div>
                ...
                <input type="submit"  class="btn btn-outline-primary  btn-block" id="add-dept" value="Add" name="Add"> 
              </form>
              </div>
               <!-- /.card-body -->
              </div>
