              ...
              <i class="fa fa-refresh fa-spin"></i>
                ...
                <form id="#"  action="#" method="POST">
                    ...
                    <div class="row">
                      ...
                      <label>Name</label>
                        <input type="text"  class="form-control" value="{{ $Employee->name }}" placeholder="Name" name="name" autocomplete="off" pattern="[a-z A-Z]*" title="Please Enter Valid Username Name"  readonly>
                      </div>
                      ...
                      <div class="col-6 form-group">
                      <label>Salary</label>
                        <input type="text" class="form-control" value="{{ $Employee->salary }}"  placeholder="Salary" name="salary" autocomplete="off"  readonly>
                      </div>
                      ...
                      <div class="col-6 form-group">
                      <label>Mobile</label>
                        <input type="number" class="form-control" value="{{ $Employee->contact }}" placeholder="Mobile" name="mobile"  minlength="10" maxlength="10" autocomplete="off" readonly>
                      </div>
                      ...
                      <div class="col-6 form-group">
                      <label>Email</label>
                        <input type="email" class="form-control" value="{{  $Employee->email }}" placeholder="Email " name="email" autocomplete="off" readonly>
                      </div>
                    ...
                    @endif
                      ...
                      <input type="date" class="form-control  unstyled"  value="{{  $Employee->joining_date }}" name="joining_date" readonly>
                      </div>
                      </div>
                ...
                <a href="{{ url('admin/employee') }}"  class="btn btn-outline-primary  btn-block" id="add-dept">Close </a>
