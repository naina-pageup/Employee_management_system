                    ...
                    <div class="card card-primary">
                        <div class="card-body">
                            ...
                            <form id="#" action="{{ url('admin/employee/update', $Employee->id) }}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-6 form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ $Employee->name }}"
                                            ...
                                            title="Please Enter Valid Username Name" required>
                                    </div>
                                    ...
                                    <div class="col-6 form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ $Employee->salary }}"
                                            placeholder="Salary" name="salary" autocomplete="off" required>
                                    </div>
                                ...
                                <input type="submit" class="btn btn-outline-warning  btn-block" id="add-dept"
