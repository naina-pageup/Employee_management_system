    ...
    <section class="content">
      ...
      <div id="loader-add-customer" style="display:none;" class="overlay">
              <i class="fa fa-refresh fa-spin"></i>
                ...
                <form id="edit-department-form" action="{{ url('/admin/department/update',['id' => encrypt($deparments->id)])}}" method="POST">
                    @csrf
                    @method('post')
                <div class="row">
                  ...
                  <label>Department</label>
                    ...
                    <input type="text" class="form-control" value="{{ $deparments->name }}"  name="name" autocomplete="off" id="Cust-name" pattern="[a-z A-Z]*" title="Please Enter Valid Username Name" min="1" required>
                  </div>
                </div>
                <input type="submit"  class="btn btn-outline-warning  btn-block" value="Edit" name="editDept"> 
              </form>
